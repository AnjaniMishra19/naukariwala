...
urlpatterns = [
    ...
    path('user/candidate_login',candidate_login),
    ...
    #candidate list
    path('user/candidate_list',candidate_list),

    #jobs
    path('job/all_jobs',all_jobs),
    path('job/post_job_status_update',post_job_status_update),
    path('job/post_job_update',post_job_update),
    path('job/post_job',post_job),
    path('job/apply_job',apply_job),
